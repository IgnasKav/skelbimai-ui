...
export default observer(function TreeSelect({
  name,
  label,
  value,
  onChange,
  ...
  const [selectedCategories, setSelectedCategories] = useState<string[] | string | undefined>(
  ...
  const findCategory = (categoryId: string) =>
    categoriesFlat.find((category) => category.id === categoryId)
