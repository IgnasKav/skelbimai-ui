...
import {
    Check, Edit, Eye, FileInfo, Map2, Settings, Trash, X,
...
export default observer(() => {
    ...
    const advertisementMutation = useMutation(
        (updatedAdvertisement: Advertisement) => agent.Advertisements.edit(updatedAdvertisement),
        {
            onSettled: () => {
    ...
    const watchLaterMutation = useMutation(
        (watchLaterRequest: WatchLater) => agent.Advertisements.toggleWatchLater(watchLaterRequest),
        {
            onSuccess: () => {
    ...
    const deleteMutation = useMutation(
        (advertisementId: string) => agent.Advertisements.delete(advertisementId),
        {
            onSuccess: () => {
