...
import { FilePlus, SquarePlus, Logout, Home} from 'tabler-icons-react';
    ...
    return (
        <Navbar width={{base: 300}}>
            <Navbar.Section grow mt="md">
                <NavBarLink onClick={(activeLink: string) => onLinkClick('/advertisementDashboard', activeLink)} icon={<Home/>}  label="Home" activeLink={active}/>
                <NavBarLink onClick={(activeLink: string) => onLinkClick('/categoriesDashboard', activeLink)} icon={<FilePlus/>}  label="New category" activeLink={active}/>
                <NavBarLink onClick={(activeLink: string) => onLinkClick('/createAdvertisement', activeLink)} icon={<SquarePlus/>}  label="New advertisement" activeLink={active}/>
            ...
            <Navbar.Section>
                <LogOutLink onClick={logout} icon={<Logout size={16}/>} color="red" label="Log out" activeLink={active}/>
            </Navbar.Section>
        </Navbar>
    )
}